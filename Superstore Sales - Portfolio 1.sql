...
-- (for product performance report):
...
-- (for customer segment report):
-- https://public.tableau.com/views/SuperstoreSales-CustomerSegmentReport/Customer?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link
